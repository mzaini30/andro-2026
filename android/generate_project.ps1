...
"@
    ...
    $proguardRules = "# No ProGuard rules needed - ads disabled"
}
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- Location for Geolocation feature -->
...
# Create MainActivity.java - Build imports and code based on ads configuration
$hasAds = ($ads -ne "" -and $ads -ne $null)
...
# Build onCreate method based on ads configuration
if ($hasAds) {
    $onCreateCode = @"
    @Override
...
# Build onBackPressed method based on ads configuration
if ($hasAds) {
    $onBackPressedCode = @"
    @Override
